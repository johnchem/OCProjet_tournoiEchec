...
if __name__ == "__main__":
    ...
    list_test_round = [(serialized_round_1, round_1), (serialized_round_2, round_2)]

    list_test_tournament = [
        (serialised_tournament_1, tournament_1),
